...
(
    `votes_sites_id`          INT UNSIGNED     NOT NULL AUTO_INCREMENT,
    `votes_sites_title`       VARCHAR(255)     NOT NULL,
    `votes_sites_url`         VARCHAR(255)     NOT NULL,
    `votes_sites_time`        INT(10) UNSIGNED NOT NULL,
...
(
    `votes_config_top_show`               INT(10) UNSIGNED NOT NULL DEFAULT '10',
    `votes_config_reset`                  INT(1) UNSIGNED  NOT NULL DEFAULT '1' COMMENT '1 = reset tous les mois\r\n0 = pas de reset mensuel',
...
ALTER TABLE `cmw_votes_votes`
    MODIFY `votes_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `cmw_votes_logs_rewards`
    MODIFY `votes_logs_rewards_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
