                ...
                <form method="post" action="rewards/add">
                    ...
                    <div class="col-12">
                        <div class="tab-content text-justify" id="nav-tabContent">
                            <?php $i = 1; foreach ($rewardMethods as $rewardMethod): ?>
                                <div class="tab-pane" id="method-<?= $rewardMethod->varName() ?>">
                                    ...
                                    <?php $rewardMethod->includeRewardConfigWidgets(); ?>
                                </div>
                                <?php ++$i; endforeach; ?>
                        </div>
                    </div>
                ...
                <table class="table" id="table1">
                    ...
                    <?php foreach ($rewards as $reward) : ?>
                        <tr>
                            ...
                            <td><?= VotesController::getInstance()->getRewardByVarName($reward->getVarName())->name() ?></td>
                            <td>
