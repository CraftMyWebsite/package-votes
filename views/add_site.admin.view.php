                ...
                <form action="" method="post">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><?= LangManager::translate("votes.dashboard.add_site.card_title") ?>
                                :</h3>
                        </div>
                        <div class="card-body">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"
                    id="sitesCompLabel"><?= LangManager::translate("votes.dashboard.add_site.sitescomp.modal_title") ?></h5>
            ...
            <div class="modal-body">
                <ul>
                    ...
                    <?php foreach ($compatiblesSites as $site => $url): ?>
                        <li><a href="<?= $site ?>" target="_blank"><?= $url ?></a></li>
                    <?php endforeach; ?>
